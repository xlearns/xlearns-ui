...
describe('Header.vue', () => {
  ...
  test('Header height', async () => {
    ...
    const vm = wrapper.vm
    expect(getComputedStyle(vm.$el).getPropertyValue('--el-header-height')).toEqual('500px')
   })
})
...
describe('Footer.vue', () => {
  ...
  test('Footer height', async () => {
    ...
    const vm = wrapper.vm
    expect(getComputedStyle(vm.$el).getPropertyValue('--el-footer-height')).toEqual('500px')
   })
})
...
describe('Aside.vue', () => {
  ...
  test('Aside height', async () => {
    ...
    const vm = wrapper.vm
    expect(getComputedStyle(vm.$el).getPropertyValue('--el-aside-width')).toEqual('500px')
   })
})
